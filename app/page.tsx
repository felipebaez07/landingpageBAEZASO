  ...
  return <>
    <section className="hero">
      <div className="hero-copy">
        <p className="eyebrow">Báez Tobar Abogados · Colombia</p>
      ...
      <div className="hero-image"><img src="/images/nicolas-baez.jpg" alt="Nicolás Báez Tobar, abogado principal" width={445} height={550} fetchPriority="high"/><span>Abogado principal</span></div>
    </section>
    ...
    <section className="section profile-preview"><img src="/images/nicolas-baez.jpg" alt="Nicolás Báez Tobar" width={437} height={540} loading="lazy"/><div><p className="eyebrow blue">Abogado principal</p><h2>Nicolás Báez Tobar</h2><p>Abogado especialista en derecho administrativo y urbano, con más de 340 procesos atendidos —143 en defensa directa de entidades públicas— y una tasa aproximada de éxito del 70&nbsp;% en los asuntos concluidos. Su práctica se distingue por el estudio detallado de cada caso y una relación profesional directa.</p><Link className="text-link dark" href="/equipo/nicolas-baez">Conocer su perfil →</Link></div></section>
